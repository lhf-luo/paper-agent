...
import {
	type PersonalPaperDetails,
	queryPersonalLibraryPaper,
} from "../application/personal-paper-query.ts";
...
export function registerPersonalLibraryQueryTool(pi: ExtensionAPI): void {
	pi.registerTool({
		...
		async execute(_toolCallId, params, _signal, _onUpdate, ctx) {
			...
			const heading = result.status === "ambiguous" ? "Multiple exact matches were found." : "No exact match was found.";
			const text = [
				heading,
