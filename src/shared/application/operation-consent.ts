...
import type { MutatingOperationKind } from "../domain/operation-confirmation.ts";

export type { MutatingOperationKind } from "../domain/operation-confirmation.ts";
...
export class OperationConsentManager {
	...
	preparedOperation(operationId: string): PreparedOperation | undefined {
