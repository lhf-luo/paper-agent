...
import { FileTeamLiteratureRepository } from "../team-server/src/infrastructure/file-team-literature-repository.ts";
...
try {
	...
	const restored = new FileTeamLiteratureRepository(restoredPath, namespace);
