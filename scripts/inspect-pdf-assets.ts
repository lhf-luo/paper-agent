...
import { loadPaperAgentConfigSync } from "../src/config/application/config-service.ts";
...
applyExternalToolDirectories(loadPaperAgentConfigSync(projectRoot).externalTools.commandDirectories);
