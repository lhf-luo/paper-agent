...
import { fetchPublicUrl } from "../src/shared/infrastructure/network-security.ts";
import { registerLiteratureDiscoveryTools } from "../src/literature/presentation/literature-discovery-tools.ts";

vi.mock("../src/shared/infrastructure/network-security.ts", async (importOriginal) => ({
	...(await importOriginal<typeof import("../src/shared/infrastructure/network-security.ts")>()),
...
function registeredFetchTool(): any {
	let fetchTool: any;
	registerLiteratureDiscoveryTools({
